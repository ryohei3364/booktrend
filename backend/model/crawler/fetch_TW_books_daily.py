...
start_url = "https://www.books.com.tw/web/sys_tdrntb/books/"
test_url = 'https://www.books.com.tw/products/0011019668?loc=P_0001_001'
...
def get_book_links():
    ...
    if response.status_code != 200:
        ...
        # 儲存成 JSON
        with open("book_links_daily_250528.json", "w", encoding="utf-8") as f:
            json.dump(sorted_links, f, ensure_ascii=False, indent=2)
        
        print(f"共找到 {len(sorted_links)} 筆書籍連結，已儲存為 book_links_250528.json")
        return sorted_links
